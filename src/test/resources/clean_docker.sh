...
docker rmi blackducksoftware/hub-docker-inspector:2.0.1
docker rmi blackducksoftware/hub-docker-inspector-centos:2.0.1
docker rmi blackducksoftware/hub-docker-inspector-alpine:2.0.1

docker rmi blackducksoftware/hub-docker-inspector:2.0.1-SNAPSHOT
docker rmi blackducksoftware/hub-docker-inspector-centos:2.0.1-SNAPSHOT
docker rmi blackducksoftware/hub-docker-inspector-alpine:2.0.1-SNAPSHOT
